...
public class DataBase_Stories extends SQLiteOpenHelper {
    ...
    public static final int DB_ID = 3 ;
  ...
  //  public static final String STORY_CLN_ID_SOUND = "IDSOUND" ;
    ...
    public void onCreate(SQLiteDatabase db) { // it's called  when construct dataBase , db variable from db .
      ...
      //  db.execSQL("CREATE TABLE "+ STORY_TB_NAME +" ("+ STORY_CLN_ID_IMG +" INTEGER ,"+" "+ STORY_CLN_STORYNAME + " TEXT , "+" "+ STORY_CLN_ID_SOUND + " INTEGER )");

    }
    //"CREATE TABLE "+ STORY_TB_NAME +" ("+ STORY_CLN_ID_IMG +" INTEGER ,"+" "+ STORY_CLN_STORYNAME + " TEXT)");

    @Override //,"+" "+ STORY_CLN_ID_SOUND + " INTEGER"
    ...
    public boolean insertStory(Stories_Card stories_card){
        ...
        values.put(STORY_CLN_ID_IMG ,stories_card.getImg());
       // values.put(STORY_CLN_ID_SOUND,stories_card.getSound());
    ...
    public ArrayList getAllStories(){
        ...
        if(cursor.moveToFirst()){
            do {
                ...
                int img = cursor.getInt(cursor.getColumnIndex(STORY_CLN_ID_IMG));
               // int sound = cursor.getInt(cursor.getColumnIndex(STORY_CLN_ID_SOUND));
                Stories_Card stories_card = new Stories_Card(name, img);
